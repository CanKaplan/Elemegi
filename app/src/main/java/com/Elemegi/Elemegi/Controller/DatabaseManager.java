...
public class DatabaseManager extends Activity {
    ...
    public String createMyFavPage(long ıd) {
        BackgroundTask backgroundTask = new BackgroundTask();
        String data_string = "u_ID=" + ıd;
        backgroundTask.setTaskContent("showFavourite.php",data_string);
        String result = "";
        try {
            result = backgroundTask.execute().get();
    ...
    public void giveOrder(long productID, long id, String note) {
        BackgroundTask backgroundTask = new BackgroundTask();
        String data_string = "p_ID=" + productID + "&u_ID=" + id + "&note=" + note;
        backgroundTask.setTaskContent("addOrder.php",data_string);
        String result = "";
        try {
            result = backgroundTask.execute().get();
        } catch (ExecutionException e) {
